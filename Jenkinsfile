               ...
               parallel(
                  CAC: {
                        ...
                        sh '''
                           ...
                           export COMMIT_ID=`cat .git/HEAD`
                           cp -r /tmp/provisioning/inspec_scripts ${WORKSPACE}/inspec_scripts
                           chmod +x ${WORKSPACE}/inspec_scripts/run_inspec.sh || true
                           cd ${WORKSPACE}/inspec_scripts/ && bash run_inspec.sh || true
                           mkdir ${WORKSPACE}/reports/inspec_scripts || true
                           rm ${WORKSPACE}/reports/inspec_scripts/tomcatproduction.json || true
                           mv ${WORKSPACE}/inspec_scripts/tomcatproduction.json ${WORKSPACE}/reports/inspec_scripts/
