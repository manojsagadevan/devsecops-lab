...
python ${WORKSPACE}/scripts/openvas/openvas-cli.py --host ${OPENVAS_HOST} --user ${OPENVAS_USER} --password ${OPENVAS_PASS} --port ${OPENVAS_PORT} --target ${TARGET_IP} --path ${WORKSPACE}/reports/${GIT_COMMIT}-openvas_report.xml
